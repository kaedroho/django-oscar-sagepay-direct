...
if TEST_MODE:
    VPS_REGISTER_URL = 'https://test.sagepay.com/gateway/service/vspdirect-register.vsp'
    VPS_AUTHORISE_URL = 'https://test.sagepay.com/gateway/service/authorise.vsp'
    VPS_REFUND_URL = 'https://test.sagepay.com/gateway/service/refund.vsp'
    VPS_VOID_URL = 'https://test.sagepay.com/gateway/service/void.vsp'
else:
